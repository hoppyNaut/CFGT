    ...
    def forward(self, inp, seq_len,lex_num=0,pos_s=None,pos_e=None):
        ...
        if self.relative_position:
            if self.four_pos_fusion_shared and self.lattice:
                # print("pos_s[0]:", pos_s.shape, pos_s[0])
                # print("pos_e[0]:", pos_e.shape, pos_e[0])
                # print("lex_num:", lex_num)
                # print("seq_len:", seq_len)
                expandPos_s, expandPos_e = self.expandLexLattice(seq_len, lex_num, pos_s, pos_e)
                # print("pos_s[0]:", pos_s.shape, pos_s[0])
                # print("pos_e[0]:", pos_e.shape, pos_e[0])
                # print("expandPos_s[0]:",expandPos_s.shape,expandPos_s[0])
                # print("expandPos_e[0]:",expandPos_e.shape,expandPos_e[0])
                # rel_pos_embedding = self.four_pos_fusion_embedding(pos_s, pos_e)
