...
parser.add_argument('--clip_ontonotes',action='store_true')
...
if args.clip_ontonotes:
    create_cliped_file('{}/train.char.bmes'.format(ontonote4ner_cn_path))
    create_cliped_file('{}/dev.char.bmes'.format(ontonote4ner_cn_path))
    create_cliped_file('{}/test.char.bmes'.format(ontonote4ner_cn_path))
